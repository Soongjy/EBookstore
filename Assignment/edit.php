...
<h1 style="text-align:center;">Edit Form</h1>
    ...
    <?php
    include("conn.php");
    $id = intval($_GET['memberID']); //intval — Get the integer value of a variable
	...
	<form action="update.php" method="post">
		...
		<table width="300px" border="0" cellspacing="1" cellpadding="3">
			...
			<tr>
				<td><input type="text" name="name" required="required" placeholder="Enter your name" value="<?php echo $row['member_name'] ?>"></td>
			</tr>
			...
			<tr>
				<td><input type="email" name="email" required="required" placeholder="Enter your email" value="<?php echo $row['email_address'] ?>"></td>
			</tr>
			...
			<tr>
				<td><input type="tel" name="phone_number" required="required" placeholder="Enter youre phone number" value="<?php echo $row['phone_number'] ?>"></td>
			</tr>
			...
			<tr>
				<td><textarea required="required" name="address" placeholder="Enter your address"><?php echo $row['address'] ?></textarea></td>
			</tr>
